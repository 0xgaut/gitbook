...
Universal provides multiple integration methods to suit your needs:

<table>
  <tr>
    <td><strong><a href="api.md">Universal API</a></strong><br/>RESTful API for just-in-time minting and redemption</td>
  </tr>
  <tr>
    <td><strong><a href="sdk.md">TypeScript SDK</a></strong><br/>Viem-compatible SDK for easy integration</td>
  </tr>
  <tr>
    <td><strong><a href="smart-contracts.md">Smart Contracts</a></strong><br/>Direct contract integration for advanced use cases</td>
  </tr>
  <tr>
    <td><strong><a href="v4-hook.md">Uniswap V4 Hook</a></strong><br/>Integrate Universal liquidity into Uniswap V4 pools</td>
  </tr>
</table>
...
The **Universal API** allows developers to seamlessly integrate uAssets into their applications with just-in-time liquidity.
...
Interact directly with Universal smart contracts for advanced use cases.
...
[View contract addresses →](smart-contracts.md)

### Uniswap V4 Hook

Leverage Universal's liquidity directly within Uniswap V4 pools using hooks.
...
[Explore V4 hooks →](v4-hook.md)

## Use Cases

### 1. Onchain Exchange with Deep Liquidity

Integrate uAssets into your DEX to offer trading pairs with deep liquidity and tighter spreads. No need for liquidity pools—orders are fulfilled dynamically via just-in-time execution.
...
Create 1:1 pools between uAssets and existing bridged assets, improving capital efficiency and reducing slippage for users trading cross-chain.
...
uAssets can be issued or burned as needed, with instant finality on supported chains.
